          ...
          <div class="form-group">
            <div class="col-sm-offset-3 col-sm-6">
              ...
              <select class="" name="title" style="height:50px; width:100%; border-radius:5px;" required />
                ...
                <option value="2">Honourable</option>
                <option value="3">Iman</option>
                <option value="1">Shaykh</option>
                <option value="2">Alhaj</option>
                <option value="3">Alhaja</option>
                <option value="1">Pastor</option>
                <option value="2">Elder</option>
                <option value="3">Revrend</option>
