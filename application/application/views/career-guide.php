<div class="container">
	<div class="row">
		<div class="col-md-12">
			<p class="career_guide">CAREER GUIDE</p>
			<p class="discretion">Choosing a wrong carrer is like going down the wrong lane for several years only to discover it iss the wrong route and having to turn back to the starting point. Most people dont ever recover and they lament for life. Whatever your career aspiration is, you are sure to find below detail information of everything you need to know to guide your decision making.</p>
		...
		<div class="container">
			<div class="row" id="result">
				...
				<div class="col-sm-4 col-md-4">
					<div class="gallery">
						<a target="" href="<?php echo "career_guide/read/" .$row->id ."/". url_title($row->title); ?>">
