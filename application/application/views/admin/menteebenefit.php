  ...
  <div class="container-fluid">
    ...
    <div class="page-header page-header-block">
      <div class="page-header-section">
        <h4 class="title semibold">Mentees Benefits</h4>
      </div>
      <div class="row">
        <div class="col-xs-12">
          ...
          <?php } ?>
          <form class="form-horizontal panel panel-default" action="updateMentee" method="post">
              <div class="panel-heading">
                <h3 class="panel-title">Benefit for Mentees</h3>
              </div>
              <?php foreach($mentee as $row) { ?>
